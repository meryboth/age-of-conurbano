...
export const BUILDINGS={
 ...
 potrero:{name:'Potrero de fútbol',short:'Potrero',subtitle:'La pelota siempre vuelve',wood:45,food:0,time:8,width:14,depth:10,size:14,lots:4,capacity:0,description:'Un baldío de cuatro lotes con césped desparejo, arcos y alambrado. Un espacio de juego para la cuadra; no produce recursos ni suma viviendas.',icon:'goal',footprint:'4 lotes · 14 × 10'},
};
